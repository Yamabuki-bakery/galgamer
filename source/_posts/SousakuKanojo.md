        ...
        <div class="closet col-12">
          ...
          <div class="closet-list"><!-- 換裝區域 -->
            ...
            <ul class="closetimg" id="aisaCloset">
              <li class="active"><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/0.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/1.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/2.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/3.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/4.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/5.webp"/></li>
              <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/1/6.webp"/></li>
            </ul>
          </div>
        </div> <!-- end closet -->
      </div>
    ...
    <div class="desc-r col-md-5 col-12">
      <div class="row">
        ...
        <div class="qchar col-9"><!-- Q 版人物 -->
          <img loading="lazy" src="../image/SousakuKanojo/chars/1/sd.webp"/>
        </div>
      </div>
    </div><!-- end desc-r -->
    ...
    <div class="row justify-content-center"><!-- chara 左右部分 -->
      ...
      <div class="orfer-md-0 desc-l col-md-5 col-12">
        <div class="row">
          ...
          <div class="qchar col-9"><!-- Q 版人物 -->
            <img loading="lazy" src="../image/SousakuKanojo/chars/2/sd.webp"/>
          </div>
        </div>
      </div><!-- end desc-l -->
    </div><!-- end chara l r row -->
    ...
    <div class="row justify-content-center"><!-- chara 左右部分 -->
          ...
          <div class="closet col-12">
            ...
            <div class="closet-list"><!-- 換裝區域 -->
              ...
              <ul class="closetimg" id="yumeCloset">
                <li class="active"><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/0.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/1.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/2.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/3.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/4.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/5.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/3/6.webp"/></li>
              </ul>
            </div>
          </div> <!-- end closet -->
        </div>
      ...
      <div class="desc-r col-md-5 col-12">
        <div class="row">
          ...
          <div class="qchar col-9"><!-- Q 版人物 -->
            <img loading="lazy" src="../image/SousakuKanojo/chars/3/sd.webp"/>
          </div>
        </div>
      </div><!-- end desc-r -->
    </div><!-- end chara l r row -->
    ...
    <div class="row justify-content-center"><!-- chara 左右部分 -->
          ...
          <div class="closet col-12">
            ...
            <div class="closet-list"><!-- 換裝區域 -->
              ...
              <ul class="closetimg" id="erenaCloset">
                <li class="active"><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/0.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/1.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/2.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/3.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/4.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/5.webp"/></li>
                <li class=""><img onclick="return false;" loading="lazy" width="805" height="1536" src="../image/SousakuKanojo/chars/4/6.webp"/></li>
              </ul>
            </div>
          </div> <!-- end closet -->
        </div>
      ...
      <div class="orfer-md-0 desc-l col-md-5 col-12">
        <div class="row">
          ...
          <div class="qchar col-9"><!-- Q 版人物 -->
            <img loading="lazy" src="../image/SousakuKanojo/chars/4/sd.webp"/>
          </div>
        </div>
      </div><!-- end desc-l -->
    </div><!-- end chara l r row -->
...
<img class="mx-0 my-2 rounded" loading="lazy" width=300px height=120px src="../image/SousakuKanojo/chars/others/0.webp"/>
...
<img class="mx-0 my-1 rounded" loading="lazy" width=200px height=80px src="../image/SousakuKanojo/chars/others/3.webp"/>
<img class="mx-0 my-1 rounded" loading="lazy" width=200px height=80px src="../image/SousakuKanojo/chars/others/4.webp"/>
<img class="mx-0 my-1 rounded" loading="lazy" width=200px height=80px src="../image/SousakuKanojo/chars/others/5.webp"/>
<img class="mx-0 my-1 rounded" loading="lazy" width=200px height=80px src="../image/SousakuKanojo/chars/others/6.webp"/>
<img class="mx-0 my-1 rounded" loading="lazy" width=200px height=80px src="../image/SousakuKanojo/chars/others/7.webp"/>
